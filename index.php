...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-146406174-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-146406174-1');
</script>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-7782167188889821",
          ...
          <div class="col-md-8">
            <div class="widget no-border m-0">
              <ul class="list-inline">
                <li class="m-0 pl-10 pr-10"><i class="fa fa-envelope-o text-white"></i> <a class="text-white">hamza.syed9995@gmail.com</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
            <div class="widget no-border m-0">
              <ul class="list-inline text-right sm-text-center">
                ...
                <li>
                  <a href="#faq" class="text-white">Help Desk</a>
                </li>
                <li class="text-white">|</li>
                <li>
                  <a href="#faq" class="text-white">Support</a>
                </li>
              </ul>
            </div>
          </div>
...
<!--                LOGO        -->
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#">Past Papers</a>
                <ul class="dropdown">
                  <li><a href="waqar-mid-term.html">Waqar Mid-Term</a></li>
                  <li><a href="moaz-mid-term.html">Moaz Mid-Term</a>
                  </li>
                  <li><a href="waqar-final-term.html">Waqar Final-Term</a>
                  </li>
                  <li><a href="moaz-final-term.html">Moaz Final-Term</a>
                  </li>
                </ul>
              </li>
                
              <li><a href="#">Current Papers</a>
                <ul class="dropdown">
                  <li><a href="#">Final-Term 2019</a>
                  </li>
                  <li><a href="#">Mid-Term 2019</a></li> 
                </ul>
              </li>
              ...
              <li><a href="#">Solutions</a>
                <ul class="dropdown">
                  <li><a href="#">Assignment Solutions</a></li>
                  <li><a href="#"> GDB Solution </a></li>
                  <li><a href="#">Solved Quiz's</a></li>
                </ul>
              </li>
                
                
              <li><a href="#">PDF/Lectures</a>
                <ul class="dropdown">
                  <li><a href="pdf.html">PDF</a></li>
                  <li><a href="short-notes.html">Short Notes</a></li>
               ...
               <li><a href="#">Softwares</a>
                <ul class="dropdown">
                  <li><a href="#">VU Related</a>
                  </li>
                  <li><a href="#">Web Devlopment</a>
                  </li>
                  <li><a href="#">Graphic Design</a>
                  </li>
                  <li><a href="#">2D 3D Animation</a>
                  </li>
                  <li><a href="#">Others</a>
                  </li>
      ...
      <div class="rev_slider_wrapper">
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <!-- SLIDE 1 -->
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/book-bindings-composition-desk-891059.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="images/bg/book-bindings-composition-desk-891059.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                style="z-index: 7; white-space: nowrap; font-weight:700;">Past Papers
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-left-theme-color-2-6px pl-20 pr-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Past Papers For EveryOne 
              </div>
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-lg btn-flat btn-theme-colored border-left-theme-color-2-6px pl-20 pr-20" href="moaz-final-term.html">View All</a> 
              </div>
            </li>
            ...
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg7.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">PDF's and Video Lectures available 
              </div>
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-circled btn-transparent pl-20 pr-20" href="#">View All</a> 
              </div>
            </li>
            ...
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Best Solutions
              </div>
              ...
              <div class="tp-caption tp-resizeme" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-lg btn-flat btn-theme-colored btn-theme-colored border-right-theme-color-2-6px pl-20 pr-20" href="#">View All</a> 
              </div>
            </li>
          ...
          <div class="row equal-height-inner mt-sm-0" data-margin-top="-150px">
            <div class="col-sm-12 col-md-6 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
              <div class="sm-height-auto" data-bg-img="images/about/h1.jpg">
                <div class="p-20">
                  <h3 class="text-white text-uppercase">Want To Get All Mid-term Past Papers?</h3>
                  <div class="clearfix">
                  </div>
                  <p class="text-white-f1 mt-10 lead">Just click the button below!</p>
                  <a href="moaz-mid-term.html" class="btn btn-default font-14 btn-theme-colored mt-10 hvr-bounce-to-left no-border">Get Papers Now</a>
                </div>
              </div>
            </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="mt-0 line-height-1 text-center text-uppercase mb-10 text-black-333">Recent <span class="text-theme-color-2"> Posts</span></h2>
              <p>Quiz, video lectures, PDF's, GDB, assignment solutions and all recent helping material that are uploaded recently are accessible here! Just Click and download them. </p>
            </div>
          </div>
        </div>
            ...
            <div class="owl-carousel-3col owl-nav-top" data-dots="true">
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper.html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS502</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy.html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS505</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (2).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS509</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (3).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS5042</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (4).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS524301</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (5).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">C432S501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (6).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS432501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (7).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">C65S501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (8).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    <!-- <h5 class="font-14 font-weight-500 mb-5">CS-101</h5> -->
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS3501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (9).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-15 pt-10 pb-10">
                    ...
                    <h4 class="font-weight-700 text-uppercase mt-0"><a href="#">CS3501</a></h4>
                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p> -->
                    <a href="paper - Copy (10).html" class="btn btn-primary">Download</a>
                  </div>
                </div>
              </div>
...
<!--      DAILY ALERTS      -->
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">Email Us</h4>
                  <p class="text-white">In order to send us an email to tell us about your queries you can send us as email to &nbsp; <a href="#">hamza.syed9995@gmail.com</a></p>
                </div>
              </div>
              <div class="icon-box clearfix m-0 p-0 pb-10">
                <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none">
                  <i class="fa fa-facebook-square text-theme-color-2 font-36"></i> 
                </a>
                <div class="ml-120 ml-sm-0">
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none">
                  <i class="fa fa-youtube-square text-theme-color-2 font-36"></i> 
                </a>
                <div class="ml-120 ml-sm-0">
    ...
    <section class="bg-lighter" id="faq">
  ...
  <footer id="footer" class="footer bg-black-222" data-bg-img="images/footer-bg.png">
      ...
      <div class="row">
        <div class="col-sm-8 col-md-5">
          <div class="widget dark">
            <h3 style="color: #fff;"> VU PAPERS</h3>
            <p class="font-16 mb-10">The purpose of this website creation is to give best and accurate knowledge to the students for which they are seeking help. We provide past papers of Mids and Final term, Assignment solutions, handouts, programming books, variety of softwares are available which will be useful for the students to acquire a knowledge base with good concepts of education.</p>
            <a class="font-14" href="#"><i class="fa fa-angle-double-right text-theme-colored"></i> Read more</a>
            <ul class="styled-icons icon-dark mt-20">
              <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".1s" data-wow-offset="10"><a href="#" data-bg-color="#3B5998" data-toggle="tooltip" data-placement="bottom" title="Facebook"><i class="fa fa-facebook"></i></a></li>
              <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s" data-wow-offset="10"><a href="#" data-bg-color="#02B0E8" data-toggle="tooltip" data-placement="bottom" title="Twitter"><i class="fa fa-twitter"></i></a></li>
              <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".3s" data-wow-offset="10"><a href="#" data-bg-color="#05A7E3" data-toggle="tooltip" data-placement="bottom" title="Skype"><i class="fa fa-skype"></i></a></li>
              <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".4s" data-wow-offset="10"><a href="#" data-bg-color="#A11312" data-toggle="tooltip" data-placement="bottom" title="Google plus"><i class="fa fa-google-plus"></i></a></li>
              <li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".5s" data-wow-offset="10"><a href="#" data-bg-color="#C22E2A" data-toggle="tooltip" data-placement="bottom" title="Youtube"><i class="fa fa-youtube"></i></a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-border">
              ...
              <li><a href="#">hamza.syed9995@gmail.com</a></li>
              <li><a href="#" class="lineheight-20">Lahore Pakistan</a></li>
            </ul>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-12">
            <p class="font-11 text-center text-black-777 m-0"><a href="#" target="_blank">VU Papers &copy; 2019 All rights reserved</a></p>
          </div>
